...
class DifferentialEvolution:
    ...
    def __init__(self, optimization_problem, population_size, mutation_factor, crossover_probability):
        ...
        self.MAX_FUNCTION_EVALUATIONS = self.dimension * 10000  # Default value of maximum function evaluations
    ...
    def solve(self):
        ...
        while self.__function_evaluations < self.MAX_FUNCTION_EVALUATIONS:
            ...
            if self.verbose:
                print 'FES: %4i | Fit: %12.8e' % (self.__function_evaluations, self.__fitness_min) + \
                      ' | CurBest:', ' '.join(map(str, self.__best))